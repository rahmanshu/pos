...
@EFragment(R.layout.fragment_history_void)
public class FragmentHistoryVoid extends Fragment {
    ...
    private void initListSearch(){
        RiwayatPenjualanAdapterVoid adapter = new RiwayatPenjualanAdapterVoid(getActivity(), transaksiPenjualanModels);
        listRiwayatPenjualan.setAdapter(adapter);
    }

    private static void riwayatJualAdapter(){
        RiwayatPenjualanAdapterVoid adapter = new RiwayatPenjualanAdapterVoid(contextOfApplication, transaksiPenjualanModelArrayList);
        listRiwayatPenjualan.setAdapter(adapter);
    }

    private static void getDataPenjualan(){
        ...
        transaksiPenjualanModelArrayList.clear();
        String URL = "content://com.trimitrasis.finosapps.ContentProvider.TransJualVoidProvider/transjualvoid";
    ...
    public static void getDataPenjualanVoid(){
        getDataPenjualan();
    }
