...
import com.trimitrasis.finosapps.Views.PrintView.DeviceListStrukActivity_;
...
@EFragment(R.layout.fragment_setting_struk_)
public class SettingPrinterStrukFragment extends Fragment {
    ...
    @ViewById
    TextView textPrinterAddress, textNamaPrinter, statusPrinterStruk;
    ...
    void afterView(){
        ...
        statusPrinterStruk.setText("Printer Struk  -  Tidak Terhubung..");
        //old
        /*
        ...
        if(!Constants.printer_address_struk.equals("")){
            textPrinterAddress.setText(Constants.printer_address_struk);
            textNamaPrinter.setText(Constants.printer_name_struk);
            statusPrinterStruk.setText("Printer Struk  -  Terhubung");
        }
        */
        customView();
    }
    ...
    private void customView(){
        ...
        statusPrinterStruk.setTypeface(FontUtils.getHelvetica_Neue_LT(getActivity()));
    }
        ...
        public void onClick(View v){
            switch (v.getId()){
                case R.id.textPrinterBuletooth:{
                    ...
                    Intent intent = new Intent(getActivity(), DeviceListStrukActivity_.class);
    ...
    public void onEvent(ActivityResultEventStruk event){
        ...
        switch (event.getRequestCode()){
            ...
            case  REQUEST_CONNECT_DEVICE:
                if(event.getResultCode() == Activity.RESULT_OK){
                    String address = event.getData().getExtras().getString(DeviceListStrukActivity_.EXTRA_DEVICE_ADDRESS);
                    ...
                    if(!Constants.printer_address_struk.equals("")){
                        textPrinterAddress.setText(Constants.printer_address_struk);
                        textNamaPrinter.setText(Constants.printer_name_struk);
                        statusPrinterStruk.setText("Printer Struk sudah -  Terhubung");
                    }
