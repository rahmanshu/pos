...
public class VendorModel implements Serializable {
    private static final long serialVersionUID = -5027159020085652049L;
    ...
    public VendorModel(Object _id, String name, String phone1, String phone2, String address, String fax,
                       String email, String recon_account, String currency, double credit_limit,
                       String payment_terms, boolean pkp, String tax_group,  UserInfoModel userInfoModel){
        this._id = _id;
        this.name = name;
        this.phone1 = phone1;
        this.phone2 = phone2;
